package com.fqf.imdemo.activity.imagecontent;
...
import com.fqf.imdemo.activity.createmessage.CreateSigImageMessageActivity;
 ...
 * 展示了下载图片的操作(具体Event请看im.sdk.debug.activity.TypeActivity})
 */
